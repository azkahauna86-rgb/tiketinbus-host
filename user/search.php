...
if (empty($from)) $from = 'Jakarta';
if (empty($to)) $to = 'Bandung';

// Build search query
$where = "DATE(r.departure_time) = '$date'";
if (!empty($from)) {
                ...
                while ($route = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="bus-card" data-price="<?php echo $route['price']; ?>" 
                        ...
                        <div class="bus-actions">
                            ...
                            <?php if (isLoggedIn()): ?>
                                <a href="booking.php?route_id=<?php echo $route['id']; ?>&passengers=<?php echo $passengers; ?>" 
                                   class="btn-select">
